...
This site is organized around what you're trying to do, not around Gamut's internal component taxonomy. Knowing the five sections below will get you to an answer faster than browsing will.
...
4. **Usage examples** — goal-first recipes that need real wiring (state, callbacks, composition), skipped for components with no state to wire up.
