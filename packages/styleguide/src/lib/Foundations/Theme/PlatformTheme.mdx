...
If you have to import the theme object from `@skillsoft/gamut-styles`, you will need to import the `platformTheme` object, as `theme` references the Core Theme.

```tsx
import { css } from '@emotion/react';
import { platformTheme, theme } from '@skillsoft/gamut-styles';
