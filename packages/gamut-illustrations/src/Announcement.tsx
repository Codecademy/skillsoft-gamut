...
export const Announcement: React.FC<IllustrationProps> = ({
  ...
  >
    <mask
      ...
      y="12"
    >
      <circle cx="240.5" cy="53.5" fill="#D9D9D9" r="41.5" />
    </mask>
    <g mask="url(#a)">
      <mask
        height="83"
        ...
        y="12"
      >
        <path d="M199 12h83v83h-83z" fill="url(#b)" />
      </mask>
      <g mask="url(#c)">
        <path d="M199 12h83v83h-83z" fill="#FFD300" />
      </g>
    </g>
    <path
    ...
    <defs>
      <pattern
        ...
        width=".048"
      >
        <use transform="scale(.01205)" xlinkHref="#e" />
      </pattern>
      <pattern
        height=".808"
        id="d"
        ...
        width="2.293"
      >
        <use transform="scale(.03583 .01262)" xlinkHref="#f" />
      </pattern>
      <image
        height="4"
        id="e"
