...
export const CodeCelebration: React.FC<IllustrationProps> = ({
  ...
  >
    ...
    <rect
      ...
      y="93.697"
    />
    <path d="M240.075 15.916v129.98H71.49V15.915z" fill="#fff" />
    <path
    ...
    <path
      ...
      strokeWidth="1.103"
    />
    <path d="M208.965 170.98v11.294H.002V170.98h208.963Z" fill="url(#b)" />
    <path
    ...
    <defs>
      <pattern
        ...
        width=".269"
      >
        <use transform="scale(.0042 .00325)" xlinkHref="#d" />
      </pattern>
      <pattern
        height=".169"
        id="b"
        ...
        width="3.126"
      >
        <use transform="scale(.04885 .00264)" xlinkHref="#d" />
      </pattern>
      <pattern
        height=".776"
        id="c"
        ...
        width="1.077"
      >
        <use transform="scale(.01683 .01213)" xlinkHref="#d" />
      </pattern>
      <image
        height="64"
        id="d"
