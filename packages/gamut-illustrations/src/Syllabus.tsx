...
export const Syllabus: React.FC<IllustrationProps> = ({
  ...
  >
    ...
    <path
      ...
      fill="#FFFAE5"
    />
    <path d="M93 29H77v217h16V29Z" fill="url(#a)" />
    <path
      d="m93.599 285.033-50.7-25.35-.548-179.052a51.217 51.217 0 0 1 51.216-51.217l.032 255.619Z"
      stroke="#10162F"
      strokeMiterlimit="10"
    ...
    <path
      ...
      strokeWidth=".517"
    />
    <path d="M249.784 47.583h-138.28v84.291h138.28V47.583Z" fill="#FFFAE5" />
    <path
    ...
    <path
      ...
      strokeWidth=".517"
    />
    <path d="m346.015 136.928-17.724 17.724-9.261-9.26" fill="#fff" />
    <path
      ...
      strokeWidth=".517"
    />
    <path d="M441.785 138.77h-81.538v14.035h81.538V138.77Z" fill="url(#b)" />
    <path d="m346.015 179.35-17.724 17.724-9.261-9.26" fill="#fff" />
    <path
      ...
      strokeWidth=".517"
    />
    <path d="M441.785 181.192h-81.538v14.035h81.538v-14.035Z" fill="url(#c)" />
    <path d="m346.015 221.772-17.724 17.724-9.261-9.26" fill="#fff" />
    <path
      ...
      strokeWidth=".517"
    />
    <path d="M441.785 223.614h-81.538v14.035h81.538v-14.035Z" fill="url(#d)" />
    <path d="m346.015 264.189-17.724 17.729-9.261-9.26" fill="#fff" />
    <path
      ...
      strokeWidth=".517"
    />
    <path d="M441.785 266.036h-81.538v14.036h81.538v-14.036Z" fill="url(#e)" />
    <path
    ...
    <defs>
      <pattern
        ...
        width=".259"
      >
        <use transform="scale(.03233 .00238)" xlinkHref="#f" />
      </pattern>
      <pattern
        height="2.359"
        id="b"
        ...
        width=".406"
      >
        <use transform="scale(.00634 .03686)" xlinkHref="#g" />
      </pattern>
      <pattern
        height="2.359"
        id="c"
